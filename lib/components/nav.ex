defmodule Fenway.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", Fenway.Scene.Sensor},
           {"Sensor (spec)", Fenway.Scene.SensorSpec},
           {"Primitives", Fenway.Scene.Primitives},
           {"Components", Fenway.Scene.Components},
           {"Transforms", Fenway.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
