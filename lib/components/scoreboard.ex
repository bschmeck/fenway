defmodule Fenway.Component.Scoreboard do
  ...
  def init(_state, _opts) do
    ...
    |> Fenway.Component.Number.add_to_graph({"home_runs", 0}, translate: {830, 130})
    |> Fenway.Component.Number.add_to_graph({"away_runs", 0}, translate: {830, 185})
    |> Fenway.Component.Number.add_to_graph({"home_hits", 0}, translate: {895, 130})
    |> Fenway.Component.Number.add_to_graph({"away_hits", 0}, translate: {895, 185})
    |> Fenway.Component.Number.add_to_graph({"home_errors", 0}, translate: {960, 130})
    |> Fenway.Component.Number.add_to_graph({"away_errors", 0}, translate: {960, 185})
