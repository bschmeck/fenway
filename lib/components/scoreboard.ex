defmodule Fenway.Component.Scoreboard do
  ...
  def init(_state, _opts) do
    ...
    |> Fenway.Component.Number.add_to_graph({"away_pitcher", :blank}, translate: {95, 130})
    |> Fenway.Component.Number.add_to_graph({"home_pitcher", :blank}, translate: {95, 185})
    |> Fenway.Component.Number.add_to_graph({"away_1", :blank}, translate: {315, 130})
    |> Fenway.Component.Number.add_to_graph({"home_1", :blank}, translate: {315, 185})
    |> Fenway.Component.Number.add_to_graph({"away_2", :blank}, translate: {355, 130})
    |> Fenway.Component.Number.add_to_graph({"home_2", :blank}, translate: {355, 185})
    |> Fenway.Component.Number.add_to_graph({"away_3", :blank}, translate: {395, 130})
    |> Fenway.Component.Number.add_to_graph({"home_3", :blank}, translate: {395, 185})
    |> Fenway.Component.Number.add_to_graph({"away_4", :blank}, translate: {465, 130})
    |> Fenway.Component.Number.add_to_graph({"home_4", :blank}, translate: {465, 185})
    |> Fenway.Component.Number.add_to_graph({"away_5", :blank}, translate: {505, 130})
    |> Fenway.Component.Number.add_to_graph({"home_5", :blank}, translate: {505, 185})
    |> Fenway.Component.Number.add_to_graph({"away_6", :blank}, translate: {545, 130})
    |> Fenway.Component.Number.add_to_graph({"home_6", :blank}, translate: {545, 185})
    |> Fenway.Component.Number.add_to_graph({"away_7", :blank}, translate: {615, 130})
    |> Fenway.Component.Number.add_to_graph({"home_7", :blank}, translate: {615, 185})
    |> Fenway.Component.Number.add_to_graph({"away_8", :blank}, translate: {655, 130})
    |> Fenway.Component.Number.add_to_graph({"home_8", :blank}, translate: {655, 185})
    |> Fenway.Component.Number.add_to_graph({"away_9", :blank}, translate: {695, 130})
